...
import { GTM_ID, assertGtmId } from "@/config/analytics.config";
...
export default function RootLayout({
    ...
    // Quebra o build se o GTM_ID estiver ausente/"undefined".
    // Ver o comentário longo em src/config/analytics.config.ts.
    assertGtmId();
