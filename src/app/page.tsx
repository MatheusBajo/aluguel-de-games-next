...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Aluguel de Games - Fliperamas, Videokê e VR para Festas desde 1993',
        description:
            'Locação de equipamentos de entretenimento para festas e eventos. Fliperamas, VR, Karaokê e muito mais. Entrega e montagem inclusas na Grande SP.',
...
/* ---------- JSON-LD ----------
 * O EntertainmentBusiness global agora vive no layout (src/app/layout.tsx →
 * globalGraph() de src/lib/schema.ts), server-side, sem duplicação. */
