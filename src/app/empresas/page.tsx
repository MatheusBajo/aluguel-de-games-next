            ...
            <section className="relative mx-auto max-w-7xl px-4 py-24 md:py-32">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    {[
                        ...
                        { num: "02", titulo: "Proposta", texto: "Você recebe em horário comercial uma proposta detalhada com equipamentos e investimento." },
                ...
                <div className="relative overflow-hidden rounded-3xl border-2 border-purple-500/40 bg-gradient-to-br from-blue-950/50 via-purple-950/50 to-pink-950/50 p-10 md:p-16">
                    ...
                    <div className="relative grid md:grid-cols-[1.5fr_1fr] gap-10 items-center">
                        ...
                        <div className="flex flex-col gap-3 md:items-end">
                            <WhatsAppCta
                                surface="empresas"
                                location="empresas_cta_final"
                                label="Falar com consultor B2B"
                            ...
                            <p className="label-arcade text-muted-foreground/70 mt-1 text-right">
                                Contrato · Fatura de locação · Grande SP
                            </p>
                        </div>
                    </div>
                </div>
