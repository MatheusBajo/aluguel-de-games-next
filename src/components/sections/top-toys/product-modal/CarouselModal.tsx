                                    ...
                                    >
                                        <article className={`relative h-full w-full rounded-3xl overflow-hidden bg-black border-2 transition-all duration-500 ${
                                            ...
                                            <div className="absolute bottom-0 left-0 right-0 p-5 md:p-7 z-20 space-y-4">
                                                {/* Fatos verificáveis no lugar do contador fake */}
                                                <div className="flex flex-wrap items-center gap-2">
                                                    <span className="text-white/80 bg-white/5 border border-white/15 px-3 py-1.5 rounded-sm text-xs font-medium">
                                                ...
                                                <div className="flex flex-col sm:flex-row gap-3">
                                                    <WhatsAppCta
                                                        ...
                                                        product={item.title}
                                                        variant="primary"
                                                        className="flex-1 border-2 border-green-400/50"
                                                    >
