                    ...
                    <div className="text-center lg:text-left space-y-4 md:space-y-6">
                        ...
                        <div className="grid grid-cols-3 gap-2 md:gap-4 py-4 md:py-6">
                            <div className="text-center lg:text-left">
                                ...
                                <div className="text-xs md:text-sm text-muted-foreground">Eventos desde 1993</div>
                            </div>
                            <div className="text-center lg:text-left">
                            ...
                            <div className="text-center lg:text-left">
                                <div className="text-xl sm:text-2xl md:text-3xl font-bold text-primary">SP</div>
                                <div className="text-xs md:text-sm text-muted-foreground">Grande SP</div>
                            </div>
                        </div>
